...
Implementation of library for processing numerical matrices in the C programming language. 

# Goal and requirements

*  Learn more about matrices
*  Solidify knowledge of structured programming
*  Writing code in Google style format.
